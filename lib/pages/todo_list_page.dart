...
class _TodoListPageState extends State<TodoListPage> {
  ...
  Todo? deletedTodo;
  int? deletedTodoPos;
  Color blue = Color.fromARGB(255, 33, 243, 243);
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        if (text.isEmpty) {
                          setState(() {
                            errorText = 'O texto nao pode ser vazio';
                          });
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        primary: const Color.fromARGB(255, 33, 243, 243),
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        action: SnackBarAction(
          label: 'Desfazer',
          textColor: Color.fromARGB(255, 33, 243, 243),
          onPressed: () {
            setState(() {
